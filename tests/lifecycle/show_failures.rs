...
fn show_rejects_ambiguous_identity_and_missing_public_key() {
    ...
    generate("ambiguous.test", None, "ed25519", None, None).expect("generate should succeed");
    ...
    generate("missing-public.test", None, "ed25519", None, None).expect("generate should succeed");
